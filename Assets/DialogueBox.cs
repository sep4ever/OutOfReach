...
public class DialogueBox : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (iterator < dialogueLines.Count - 1 && Input.GetKey(KeyCode.E) && finished) iterator++;
    }
    ...
    void Type()
    {
        ...
        //else if (Input.GetKey(KeyCode.E) && !finished) text.maxVisibleCharacters = dialogueLines[iterator].Length;
    }
